...
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_cdatetime, cmm_score) values (1, 'This restroom was impressively clean and accessible. Its spacious and well-maintained, perfect for wheelchair users!', 5, TRUE, 4, 4, NOW(), 0);
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_cdatetime, cmm_score) values (1, 'There was no toilet paper available during my visit. Otherwise, it seemed fine, but supply tracking needs improvement.', 3, FALSE, 3, 2, NOW(), 0);
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_cdatetime, cmm_score) values (2, 'The restroom was clean, but the hand dryer was broken, and I didnt find any paper towels. Regular checks are necessary.', 4, TRUE, 2, 3, NOW(), 0);
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_cdatetime, cmm_score) values (3, 'The restroom needs more attention; it was not very clean, with stains on the floor and an overflowing trash bin.', 2, TRUE, 2, 4, NOW(), 0);
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_cdatetime, cmm_score) values (4, 'Accessible but lacking supplies; no hand sanitizer and an empty soap dispenser. These details matter!', 4, FALSE, 4, 5, NOW(), 0);
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_cdatetime, cmm_score) values (5, 'Decent experience, but it could be cleaner, especially around the sinks where water accumulates.', 3, TRUE, 1, 1, NOW(), 0);
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_cdatetime, cmm_score) values (6, 'Great overall! Clean, well-stocked, and excellent accessibility features made my visit comfortable.', 5, FALSE, 5, 5, NOW(), 0);
insert into comment (cmm_int_id, cmm_text, cmm_rclean, cmm_rpaper, cmm_rstructure, cmm_raccessibility, cmm_cdatetime, cmm_score) values (5, 'Good accessibility but lacking in supplies. The paper towels were out, and the soap dispenser was low.', 3, TRUE, 2, 3, NOW(), 0);
