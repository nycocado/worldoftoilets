...
/**
 * Decorador Swagger para Ativar Toilet
 *
 * @function ApiSwaggerEnableToilet
 * @description Decorator que documenta o endpoint PUT /toilet/:publicId/manage/enable no Swagger.
 */
