...
/**
 * DTO de Request para Obter Toilets (Gestão)
 *
 * @class GetToiletsManageRequestDto
 * @description Transfer Object para requisição de listagem de toilets com filtros para gestão.
 * Permite filtrar por localização, acesso, extras, status e paginação. Requer permissão VIEW_ALL_TOILETS.
 *
 ...
 * @property {ToiletStatus} [status] - Filtrar por status (default: ACTIVE)
...
export class GetToiletsManageRequestDto {
   ...
   * @type {ToiletStatus}
   * @enum {string}
   * @description Status do toilet (SUGGESTED, ACTIVE, INACTIVE)
   * @example "SUGGESTED"
   */
