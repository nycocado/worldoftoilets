...
/**
 * DTO de Request para Listar Respostas (Público)
 *
 * @class GetRepliesRequestDto
 * @description Transfer Object para requisição de listagem paginada de respostas públicas
 *
